...
import os, re, time, asyncio, json, glob 
from pyrogram import Client, filters
from pyrogram.types import Message
from pyrogram.errors import FloodWait, RPCError, UserNotParticipant, MessageNotModified
    ...
    try:
        ...
        if m.media:
            ...
            try:
                ...
                try: await smsg.edit(f'❌ Upload Failed: {str(e)}')
                except: pass
...
@X.on_message(filters.text & filters.private & ~login_in_progress & ~filters.command([
    ...
    'pay', 'redeem', 'gencode', 'single', 'generate', 'keyinfo', 'encrypt', 'decrypt', 'keys', 'setbot', 'rembot', 'plan', 'clone']))
