...
async def set(_, message):
    MessageManager.delete_command(_, message)
    
    if message.from_user.id not in OWNER_ID:
        msg = await message.reply("You are not authorized to use this command.")
        MessageManager.delete_error(_, msg)
        return
...
async def help(client, message):
    MessageManager.delete_command(client, message)
